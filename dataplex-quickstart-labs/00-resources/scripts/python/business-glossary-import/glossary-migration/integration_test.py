...
if __name__ == "__main__":
    ...
    subprocess.run([sys.executable, "run.py", "--project", project, "--user-project", project, "--staging", "--glossaries", f"projects/{project}/locations/{location}/entryGroups/test_staging_eg_v6/glossaries/test_staging_glos_v6"])
